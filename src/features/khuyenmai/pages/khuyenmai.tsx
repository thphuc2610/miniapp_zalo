...
import { getSpaPromos } from "service/spaData";
        ...
        {promos.map((promo) => (
          ...
          >
            ...
            <div style={{ padding: 14 }}>
              ...
              <div style={{ background: "#fff7fb", border: "1px solid #be185d", borderRadius: 10, padding: "8px 10px", marginBottom: 12, display: "flex", flexDirection: "column", gap: 4 , boxShadow: "0 6px 8px rgba(0, 0, 0, 0.14)"}}>
