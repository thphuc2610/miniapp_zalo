import { SpaBooking } from "features/datlich/types/booking";
...
import { getSpaBookings, getSpaServices } from "service/spaData";
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {filteredBookings.map((booking) => {
              ...
              return (
                <Box
                  key={booking.id}
                  style={{ padding: 12, background: "#fff", border: "1px solid #be185d", borderRadius: 16, boxShadow: "0 6px 8px rgba(0, 0, 0, 0.14)" }}>
