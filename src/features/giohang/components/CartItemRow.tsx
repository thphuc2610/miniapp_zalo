      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 2, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 2 }}>
            ...
            <div className="quantity-stepper" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#fff", borderRadius: 8, border: "none", padding: "2px", width: 76, flexShrink: 0, boxShadow: "none" }}>
              <button
