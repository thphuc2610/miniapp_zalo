...
import { getSpaMembershipTiers, getSpaPromos } from "service/spaData";
...
const getTierTone = (name?: string) => {
  ...
  if (rank === "diamond") {
    return {
      background: "linear-gradient(135deg, #dff7ff 0%, #2f8fd3 48%, #173d79 100%)",
      border: "#7dd3fc",
      text: "#eff6ff",
      solid: "#2563eb",
    };
  ...
  if (rank === "platinum") {
    return {
      background: "linear-gradient(135deg, #eef2f7 0%, #8a98a8 46%, #3f4b5c 100%)",
      border: "#99f6e4",
      text: "#f0fdfa",
      solid: "#0f766e",
    };
  ...
  if (rank === "gold") {
    return {
      background: "linear-gradient(135deg, #fff3b0 0%, #d7a326 42%, #8f5b12 100%)",
      border: "#fbbf24",
      text: "#fff7ed",
      solid: "#d97706",
    };
  ...
  if (rank === "silver") {
    return {
      background: "linear-gradient(135deg, #f8fafc 0%, #b8c1cc 45%, #687383 100%)",
      border: "#cbd5e1",
      text: "#111827",
      solid: "#7d8998",
    };
...
export const MembershipTiersPage: FC = () => {
  ...
  return (
    <Page className="membership-no-border" style={{ height: "100vh", background: "#fdf2f8", overflowY: "auto", overflowX: "hidden", paddingBottom: 80 }}>
      <Header
      ...
      <div style={{ padding: 16 }}>
        <section
          style={{
            ...
            color: "#fff",
            boxShadow: "0 16px 34px rgba(15, 23, 42, 0.16), inset 0 1px 0 rgba(255,255,255,0.35)",
          }}
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 14 }}>
            <div style={{ background: "rgba(255,255,255,0.14)", border: "none", borderRadius: 12, padding: 10 , boxShadow: "var(--shadow-card)"}}>
            ...
            <div style={{ background: "rgba(255,255,255,0.14)", border: "none", borderRadius: 12, padding: 10 , boxShadow: "0 6px 8px rgba(0, 0, 0, 0.14)"}}>
                      ...
                      >
                        <span
                          style={{
                            ...
                            border: "none",
                            boxShadow: isSelected ? "0 10px 20px rgba(15,23,42,0.16), inset 0 1px 0 rgba(255,255,255,0.35)" : "var(--shadow-chip)",
          ...
          >
            ...
            <div
              style={{
                ...
                color: "#be185d",
                marginBottom: 14,
                border: "none", boxShadow: "0 6px 8px rgba(0, 0, 0, 0.14)"}}
            >
