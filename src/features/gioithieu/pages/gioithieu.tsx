...
const ABOUT_RICHTEXT_CSS = [
  ".about-rich-content img { max-width: 100%; height: auto; border-radius: 12px; margin: 12px 0; }",
  ".about-rich-content p { margin: 0 0 14px; }",
  ".about-rich-content h1, .about-rich-content h2, .about-rich-content h3 { color: #831843; line-height: 1.35; margin: 20px 0 10px; text-align: left; font-weight: 900; }",
  ".about-rich-content h1 { font-size: 22px; }",
  ".about-rich-content h2 { font-size: 20px; }",
  ".about-rich-content h3 { font-size: 18px; }",
  ".about-rich-content ul, .about-rich-content ol { padding-left: 20px; margin: 0 0 14px; }",
  ".about-rich-content li { margin-bottom: 7px; }",
].join("\\n");
    ...
    <Page className="flex flex-col" style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ overflowY: "auto", flex: 1, paddingBottom: 40, }}>
        <Box className="text-center" style={{ marginTop: "2em", padding: "0 14px 20px", }}>
          ...
          >
            <img src={logoUrl} style={{ width: "92%", height: "92%", objectFit: "contain", }} />
          </div>
          ...
          {/* Nội dung giới thiệu */}
          <style>{ABOUT_RICHTEXT_CSS}</style>
          <div className="about-rich-content" style={{ fontSize: 15, color: "#334155", lineHeight: 1.9, textAlign: "justify", fontWeight: 500, padding: "0 4px", }}
