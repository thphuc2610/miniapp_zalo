  ...
  return (
    <div style={{ marginTop: 26 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: "#831843" }}>Dịch vụ nổi bật</div>
        <div
      ...
      <div style={{ display: "flex", alignItems: "stretch", gap: 12, overflowX: "auto", paddingBottom: 8, WebkitOverflowScrolling: "touch", scrollbarWidth: "none" }}>
        {loading ? (
          Array.from({ length: 4 }).map((_, idx) => (
            <div
              key={idx}
              style={{ width: 175, flexShrink: 0, background: "#fff", borderRadius: 16, border: "1px solid #fdf2f8", padding: 10 }}
            >
          ...
          filtered.map((service) => (
            ...
            >
              ...
              <img src={service.image} alt={service.title} style={{ width: "100%", aspectRatio: "1/1", objectFit: "cover", background: "#f3f4f6" }} />
