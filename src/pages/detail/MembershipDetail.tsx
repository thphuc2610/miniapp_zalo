...
import { SpaMembership } from "service/spaData";
  ...
  return (
    <div style={{ position: "relative", minHeight: "100%", paddingBottom: 120 }}>
      <div style={{ padding: 16 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: 16, border: "1px solid #fce7f3", boxShadow: "0 4px 16px rgba(0,0,0,0.02)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8 }}>    
          <button
            onClick={onOpenInquiry} style={{ flex: 1, background: "#e1efff", color: "#be185d", border: "none", padding: "12px", borderRadius: 12, fontSize: 13, fontWeight: 700 }}>Tư vấn ngay</button>
          <button
